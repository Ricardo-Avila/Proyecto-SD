...
#Funcion que busca el siguiente id que tendra el usuario
def obtener_siguiente_id_usuario(conexion):
    try:
        ...
        return None
#Funcion que busca el siguiente id que tendra el ingeniero
def obtener_siguiente_id_ingeniero(conexion):
    try:
        ...
        return None
#Funcion que busca el siguiente id que tendra el dispositivo
def obtener_siguiente_id_dispositivo(conexion):
    try:
        ...
        return None
#Funcion que busca el siguiente id que tendra el ticket
...
#Guarda los valores en ingeniero
...
#Guarda los valores en dispositivos
...
#Elimina una linea en usuario en base a su id
...
#Elimina una linea en ingeniero en base a su id
...
#Elimina una linea en dispositivo en base a su id
...
#Elimina una linea en ticket en base a su id
...
#Consulta los valores de un usuario mediante su id
def consultar_usuario_por_id(conexion, id_usuario):
    try:
        ...
        return None
#Consulta los valores de un ingeniero mediante su id
def consultar_ingeniero_por_id(conexion, id_ingeniero):
    try:
        ...
        return None
#Consulta los valores de un dispositivo mediante su id
def consultar_dispositivo_por_id(conexion, id_dispositivo):
    try:
        ...
        return None
#Consulta los valores de un ticket mediante su id
def consultar_ticket_por_id(conexion, id_ticket):
    try:
        ...
        return None
#Consulta los valores de un ticket mediante el id del usuario 
def consultar_ticket_por_id_user(conexion, id_user):
    try:
        ...
        return None
#Consulta los valores de un ticket mediante el id del ingeniero
...
def consultar_folios(conexion):
    try:
        ...
        return None
#Genera los folios concatenando columnas de tickets
def generar_folio(id_usuario, id_ingeniero, sucursal, id_ticket):
    ...
    return folio
#Permite editar una linea en usuarios
...
#Permite editar una linea en ingeniero
...
#Permite editar una linea en dispositivo
...
#Permite editar una linea en ticket
def editar_datos_ticket(conexion, id_ticket, nueva_descripcion, nuevo_estado, nuevo_ingeniero_id, nuevo_dispositivo_id,sucursal):
    try:
        cursor = conexion.cursor()
...
#Muestra todos los ingenieros que hay en la BD
...
#Muestra todos los dispositivos que hay en la BD
...
#Muestra todos los tickets que hay en la BD
